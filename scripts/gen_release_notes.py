...
def render_notes(
    ...
    lines += [
        ...
        "## Attribution",
        "",
        "Includes DB-IP Lite (CC BY 4.0), IP2Location LITE (CC BY-SA 4.0), X4BNet",
        "lists_vpn (MIT), and IPtoASN (public domain) data — keep `ATTRIBUTION.txt`",
        "and `VPN-ATTRIBUTION.txt` alongside redistributed copies.",
        "",
        "---",
        "",
