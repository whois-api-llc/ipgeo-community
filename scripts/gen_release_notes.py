...
def render_notes(
    ...
    lines += [
        ...
        "(Public Domain, PDDL v1.0) data. ipgeo Community Edition uses the",
        "IP2Location LITE database for [IP geolocation](https://www.ip2location.com),",
        "under [IP2Location's own Terms of Use](https://lite.ip2location.com/data-license)",
        "— not a Creative Commons licence. Keep `ATTRIBUTION.txt` and",
        "`VPN-ATTRIBUTION.txt` alongside redistributed copies.",
        "",
        "---",
        "",
